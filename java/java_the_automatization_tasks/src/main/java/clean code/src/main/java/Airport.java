...
public class Airport {
    ...
    public List<PassengerPlane> getPasengerPlane() {
    ...
    public PassengerPlane getPassengerPlaneWithMaxPassengersCapacity() {
        List<PassengerPlane> passengerPlanes = getPasengerPlane();
    ...
    private void displayPlanes(Collection<? extends Plane> collection) {
